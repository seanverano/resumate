...
const Header = () => {
  ...
  return (
    <header className="fixed top-4 z-50 w-full">
      <nav className="animate__animated animate__fadeIn animate__duration-2000 animate__delay-3s bg-[#ECEEEE] bg-opacity-50 backdrop-filter backdrop-blur-lg saturate-180 rounded-full shadow-lg mx-auto w-[90%] z-10">
        {" "}
