...
const Hero = () => {
  ...
  return (
    <section className="p-0 mx-2 flex items-center justify-between h-screen mt-4">
      <div className="overflow-hidden flex-1 animate__animated animate__slideInLeft animate__duration-2000 animate__delay-1s">
      ...
      <div className="flex-1">
        <img
          src={HeroImage}
          alt="Hero Decoration"
          className="overflow-hidden w-full h-auto animate__animated animate__slideInRight animate__duration-2000 animate__delay-1s"
        />
      </div>
    </section>
  );
